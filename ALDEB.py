...
IVASMS_DASHBOARD = {
    ...
    "username": "ahmedmmkk90@gmail.com",
    "password": "ahmed asd",
...
# ======================
USERNAME = "l4l33"
PASSWORD = "mafia number"
BOT_TOKEN = "8787226902:AAEwZN3eXCAYwYnx-V9Wg_wUGM_rIgObV7s"
CHAT_IDS = [
    "-1003835391551",
]
REFRESH_INTERVAL = 3
...
def send_welcome(message):
    ...
    fancy_text = (
        "<b>❍<u>𓏺 ˛ 𓏺𝗙𝗬𝗡𝗜𝗫 𝗡𝗨𝗠𝗕𝗘𝗥 𝗢𝗧𝗣 . 𝒃𝒐𝒕 </u>❍</b>\n\n"
        "<b>🔋 <u>مـنـور بـوت • 𓏺 𓏺𝗙𝗬𝗡𝗜𝗫 𝗡𝗨𝗠𝗕𝗘𝗥 𝗢𝗧𝗣 . • يـحـب</u></b>\n\n"
        "<b>🎓 <u>الـمـطـور</u>  • <a href='tg://user?id=8551473585'>˛𓏺𝗙𝗬𝗡𝗜𝗫 </a></b>\n\n"
        "<b>────────────────────</b>\n"
...
def handle_country_selection(call):
    ...
    # زر الجروب في الأعلى
    markup.add(types.InlineKeyboardButton(" خــش جــــروب الاكـــــواد يــا حـــب🔱", url="https://t.me/FYNIXOTP"))
...
def change_number(call):
    ...
    markup.add(types.InlineKeyboardButton("اشـتـرك هـنـا يـحـب🔱", url="https://t.me/FYNIXOTP"))
...
def back_to_countries(call):
    ...
    fancy_text = (
        "<b>❍<u> 𓏺 𓏺𝗙𝗬𝗡𝗜𝗫 𝗡𝗨𝗠𝗕𝗘𝗥 𝗢𝗧𝗣 .𝒃𝒐𝒕 </u>❍</b>\n\n"
        "<b>🔋 <u>مـنـور بـوت • 𓏺𝗙𝗬𝗡𝗜𝗫 𝗡𝗨𝗠𝗕𝗘𝗥 𝗢𝗧𝗣 . • يـحـب</u></b>\n\n"
        "<b>🎓 <u>الـمـطـور</u>  • <a href='tg://user?id=8551473585'>𓏺𝗙𝗬𝗡𝗜𝗫</a></b>\n\n"
        "<b>────────────────────</b>\n"
        "<b><u>اخـتـر الــدولـة الـتـي تـريـدهـا مـن الـزر الاسـفـل</u> ⬇️</b>"
    )
    ...
    try:
        ...
        keyboard = {
            "inline_keyboard": [
                ...
                [
                    {"text": "💬 𝑆𝑀𝑆 ↗️", "url": "https://t.me/FYNIXOTP"},
                    {"text": "𝐵𝑂𝑇 ↗️", "url": "https://t.me/"}
                ],
                
                # الصف الثالث: زر المطور
                [
                    {"text": "𓆩𝘽𝙤𝙩 𝘾𝙝𝙖𝙣𝙣𝙚𝙡𓆪 ↗️", "url": "https://t.me/k_ho_f"}
                ]
            ]
        }
    except Exception as e:
